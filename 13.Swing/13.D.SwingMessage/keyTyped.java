/*Using Swing,write a program using the appropriate adapter class to display the message(“Typed character is: ”) in the frame window when the user types any key.*/
